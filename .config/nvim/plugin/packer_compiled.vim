...
_G.packer_plugins = {
  ...
  ["lightline.vim"] = {
    loaded = true,
    path = "/home/jason/.local/share/nvim/site/pack/packer/start/lightline.vim"
  },
  ["lspkind-nvim"] = {
    loaded = true,
  ...
  undotree = {
    loaded = true,
    path = "/home/jason/.local/share/nvim/site/pack/packer/start/undotree"
  },
  ...
  ["vim-easymotion"] = {
    loaded = true,
    path = "/home/jason/.local/share/nvim/site/pack/packer/start/vim-easymotion"
  },
  ["vim-fugitive"] = {
    loaded = true,
  ...
  ["vim-gitgutter"] = {
    loaded = true,
    path = "/home/jason/.local/share/nvim/site/pack/packer/start/vim-gitgutter"
  },
  ["vim-latex"] = {
    loaded = true,
    path = "/home/jason/.local/share/nvim/site/pack/packer/start/vim-latex"
  },
  ["vim-lexical"] = {
    loaded = true,
    path = "/home/jason/.local/share/nvim/site/pack/packer/start/vim-lexical"
  },
  ["vim-misc"] = {
    loaded = true,
  ...
  ["vim-pencil"] = {
    loaded = true,
    path = "/home/jason/.local/share/nvim/site/pack/packer/start/vim-pencil"
  },
  ["vim-sendtowindow"] = {
    loaded = true,
    path = "/home/jason/.local/share/nvim/site/pack/packer/start/vim-sendtowindow"
  },
  ["vim-snippets"] = {
    loaded = true,
  ...
  ["vim-startify"] = {
    loaded = true,
    path = "/home/jason/.local/share/nvim/site/pack/packer/start/vim-startify"
  },
  ["vim-surround"] = {
    loaded = true,
  ...
  ["vim-wordy"] = {
    loaded = true,
    path = "/home/jason/.local/share/nvim/site/pack/packer/start/vim-wordy"
  },
  vimtex = {
    loaded = true,
    path = "/home/jason/.local/share/nvim/site/pack/packer/start/vimtex"
  }
}
